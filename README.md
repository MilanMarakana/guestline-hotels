...
## To run this project in your local environments, download the zip files or clone the project from the repo url.
...
It will download all the require dependencies of the project
